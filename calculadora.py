...
button9=Button(my_frame, text="9", width=5, height=2)
...
button6=Button(my_frame, text="6", width=5, height=2)
button6.config(bd=10)
button6.config(relief="groove")
button6.grid(row=4, column=3)

button5=Button(my_frame, text="5", width=5, height=2)
button5.config(bd=10)
button5.config(relief="groove")
button5.grid(row=4, column=2)

button4=Button(my_frame, text="4", width=5, height=2)
...
button3=Button(my_frame, text="3", width=5, height=2)
button3.config(bd=10)
button3.config(relief="groove")
button3.grid(row=5, column=3)

button2=Button(my_frame, text="2", width=5, height=2)
button2.config(bd=10)
button2.config(relief="groove")
button2.grid(row=5, column=2)

button1=Button(my_frame, text="1", width=5, height=2)
...
comma_button=Button(my_frame, text=".", width=5, height=2)
comma_button.config(bd=10)
comma_button.config(relief="groove")
comma_button.grid(row=6, column=1)

button0=Button(my_frame, text="0", width=5, height=2)
